...
service = roslibpy.Service(client, 'server/register_drone', 'isaacs_server/register_drone')
...
topics_published = [{'name': 'test_name', 'type':
    'std_msgs/String'}] 
topics_service = roslibpy.Service(client, 'server/save_drone_topics', 'isaacs_server/save_drone_topics')
...
shutdown_service = roslibpy.Service(client, 'server/shutdown_drone', 'issacs_server/shutdown_drone')
